'''
@file    : /Users/jingbx/Paper2/PCA/modules/models/attn/PLA.py
@date    : 2025-08-06 13:54:38
@author  : Jingbx(18804328557@163.com)
@brief   :
-----
Last Modified: 2025-08-06 13:56:52
-----
@history :
================================================================================
...
if __name__ == '__main__':
    ...
    # 输出输入图片张量和输出图片张量的形状
    print("CV_pla input_size:", input.size())
    print("CV_pla input_size:", output.size())
